...
export class SeleccionMetodologiaComponent implements OnInit {
  ...
  miFormulario:FormGroup= this.fb.group({
    ...
    pregunta4:['2',[Validators.required]],
    pregunta5:['2',[Validators.required]],
    pregunta6:['2',[Validators.required]],
    pregunta7:['2',[Validators.required]],
    pregunta8:['2',[Validators.required]],
    pregunta9:['2',[Validators.required]],
    pregunta10:['2',[Validators.required]],
    pregunta11:['2',[Validators.required]],
    pregunta12:['2',[Validators.required]],
    pregunta13:['2',[Validators.required]],
    pregunta14:['2',[Validators.required]],
    pregunta15:['2',[Validators.required]],
    pregunta16:['2',[Validators.required]],
    pregunta17:['2',[Validators.required]],
